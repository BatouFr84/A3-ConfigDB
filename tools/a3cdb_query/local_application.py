...
class A3ConfigDBApplication:
    ...
    def health(self) -> ApplicationResponse:
        return ApplicationResponse(200, {
            ...
            "dataset": self.snapshot.snapshot_id if self.snapshot is not None else None,
        })
    ...
    def dataset_status(self) -> ApplicationResponse:
        if self.snapshot is None:
            return ApplicationResponse(200, {
                ...
                "data": {
                    "loaded": False,
                    "path": str(self.dataset_path) if self.dataset_path is not None else None,
        ...
        return ApplicationResponse(200, {
            ...
            "data": {
                ...
                "roots": list(self.snapshot.roots),
    ...
    def _require_dataset(self) -> ApplicationResponse | None:
        if self.snapshot is not None:
            return None
        return ApplicationResponse(503, {
            "status": "error",
            "error": {
                "code": "DATASET_NOT_LOADED",
                "message": self.load_error or "no dataset is loaded",
            },
        })
