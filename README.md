...
- **Local Database** — the recommended mode; users generate and index their own data locally.
...
A3-ConfigDB is licensed under the GNU Affero General Public License, version 3 or later (`AGPL-3.0-or-later`). See `LICENSE`.
